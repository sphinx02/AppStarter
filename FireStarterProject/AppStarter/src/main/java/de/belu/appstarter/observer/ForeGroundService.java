...
import de.belu.appstarter.gui.AppActivity;
import de.belu.appstarter.gui.MainActivity;
        ...
        TimerTask timerTask = new TimerTask()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    appStarterUpdater.checkForUpdate(true);
                    AppActivity.LATEST_APP_VERSION = appStarterUpdater.getLatestVersion();
                }
                catch(Exception e)
                {
